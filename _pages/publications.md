...
1. K. Lee, R. Bhattacharya, On the Uniqueness of Stationary Solutions of an Asynchronous Parallel and Distributed Algorithm for Diffusion Equations, **IEEE CCWC**, 2019.
1. K. Lee, R. Bhattacharya, Design of Resource-Optimal Switching for Resource-Constrained Dynamical Systems, **International Journal of Control, Automation, and Systems**,  Vol 16, No 3, June 2018.
...
1.  K. Lee, R. Bhattacharya, J. Dass, V. Sakuru, and R. Mahapatra, [A Relaxed Synchronization Approach for Solving Parallel Quadratic Programming Problems with Guaranteed Convergence](http://people.tamu.edu/~animodor/papers/(C)IPDPS2016.pdf), **IPDPS**, Chicago,2016.
...
1.  A. Halder, R. Bhattacharya, [Geodesic Density Tracking with
    ...
    Modeling](http://arxiv.org/abs/1402.1697), **ACC**, 2014.
...
1.  A. Tiwari, J. Fung, J. M. Carson III, R. Bhattacharya, R. M. Murray,
    ...
    Problems](http://dx.doi.org/10.1109/ACC.2004.249029), **IEEE
    Conference on Decision and Control**, Bahamas, 2004.
